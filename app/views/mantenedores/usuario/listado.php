                ...
                <tbody>
                    ...
                    <tr>
                           ...
                           <td><a href="<?=base_url()?>modificar_usuario/<?=$value['RutUsuario']?>" ><button type="button" class="btn btn-default" aria-label="Left Align"><span class="glyphicon glyphicon-edit" ></span></button></a></td>
                            <td><a href="<?=base_url()?>eliminar_usuario/<?=$value['idUsuario']?>" ><button type="button" class="btn btn-default" aria-label="Left Align"><span class="glyphicon glyphicon-remove"></span></button></a></td>
