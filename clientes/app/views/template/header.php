...
<div id="wrapper">
     ...
     <!--<div class="panel panel-default">
        <div class="panel-footer" align="center">
            <img alt="Brand" src="<?=base_url()?>img/Banner_Deudores.jpg">
        </div>
    </div>-->
        <!-- Navigation -->
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li><?=$this->session->userdata('nombre_completo_cliente')?> / Cliente</li>
            <!--- Menu Solicitudes -->
            <li class="dropdown">
...
get_solicitudes_abierta(3)?> </a>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?php
                     $base_url=  str_replace("clientes/", "", base_url());
                     echo $base_url;
                    ?>"><i class="fa fa-sign-out fa-fw"></i> <?=$this->session->userdata("nombre_completo")?></a>
                    </li>
