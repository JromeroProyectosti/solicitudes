    ...
    <body>
        <div class="container">
            <?php echo form_open_multipart('usuarios/ini_session',array("class"=>"form-signin"));?>
                ...
                <label for="txtUsuario" class="sr-only">Usuario</label><input type='text' name='txtUsuario' placeholder="E-mail"  class="form-control" required autofocus>
                ...
                <a href="recuperar_password">Recuperar Contraseña</a> | <a href="registro">Registrate</a>
            </form>
        </div>
    </body>
</html>